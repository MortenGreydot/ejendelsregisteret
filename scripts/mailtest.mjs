...
function template({ heading, preheader, paragraphs, button, footnote }) {
...
function checkoutAbandoned(to, name) {
  ...
  return sendEmail({
    ...
    preheader:
      "Betalingen blev ikke gennemf\xF8rt. Der er ikke trukket penge \u2014 du kan g\xF8re det f\xE6rdigt n\xE5r du vil.",
    paragraphs: [
    ...
    footnote:
      "Har du fortrudt, kan du roligt se bort fra denne mail. Vi sender kun denne ene p\xE5mindelse.",
    unsubscribe: true,
  });
}
